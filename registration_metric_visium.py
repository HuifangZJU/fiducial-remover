...
for i in range(len(registration_pair)):
    # Read all images
    ...
    # SSIM
    ssim_scores['Original ITK (marker)'].append(calculate_ssim(fixed_original, moving_original))
    ssim_scores['Original ITK (vispro)'].append(calculate_ssim(fixed_vispro, moving_vispro))
    ssim_scores['Registered (marker)'].append(calculate_ssim(fixed_original, itk_registered_original))
    ssim_scores['Registered (vispro)'].append(calculate_ssim(fixed_vispro, itk_registered_vispro))
