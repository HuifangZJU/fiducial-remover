...
for i in range(6,40,1):
    ...
    # a1[0, 1].imshow(m1)
    # a1[0, 2].imshow(w1)
    a1[0, 0].imshow(cv2.addWeighted(mm1, 0.5, f1, 0.5, 0))
    a1[0, 1].imshow(cv2.addWeighted(m1, 0.5, f1, 0.5, 0))
    a1[0, 2].imshow(cv2.addWeighted(w1, 0.5, f1, 0.5, 0))
    a1[0, 3].imshow(f1)
    ...
    # a1[1, 1].imshow(m2)
    # a1[1, 2].imshow(w2)
    a1[1, 0].imshow(cv2.addWeighted(mm2, 0.5, f2, 0.5, 0))
    a1[1, 1].imshow(cv2.addWeighted(m2, 0.5, f2, 0.5, 0))
    a1[1, 2].imshow(cv2.addWeighted(w2, 0.5, f2, 0.5, 0))
    a1[1, 3].imshow(f2)
    # blended2 = get_blended_image(f2, w2)
